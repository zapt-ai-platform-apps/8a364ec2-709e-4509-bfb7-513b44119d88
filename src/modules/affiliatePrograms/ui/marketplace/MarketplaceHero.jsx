...
export default function MarketplaceHero({ searchTerm, onSearch, appCount }) {
  ...
  return (
    <section className="relative overflow-hidden py-10 bg-gradient-to-br from-primary-900 via-primary-800 to-accent-900 text-white">
            ...
            <div className="md:max-w-xl">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-2 leading-tight">
                ...
                <span className="relative">
                  <svg className="absolute -bottom-2 w-full" xmlns="http://www.w3.org/2000/svg" height="8" viewBox="0 0 200 12" fill="none" preserveAspectRatio="none">
              ...
              <p className="text-lg text-white/80">
                High-quality apps with verified lifetime commissions.
              </p>
            </div>
                ...
                <div className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      <div className="w-9 h-9 rounded-full flex items-center justify-center bg-accent-500/20">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-9 h-9 rounded-full flex items-center justify-center bg-primary-500/20">
            ...
            <div className="max-w-3xl mx-auto mt-4">
              <form onSubmit={handleSubmit} className="relative">
                <input
                  ...
                  className="w-full p-3 pl-10 pr-14 rounded-full border-2 border-white/20 bg-white/10 backdrop-blur-lg text-white placeholder-white/60 shadow-lg focus:border-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-400/50 box-border"
                />
